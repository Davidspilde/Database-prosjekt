...
for i in range(1, 11):
    for j in range(1, RadSizeParkett[i-1] + 1):
...
for i in range(1, 5):
    for j in range(1, RadSizeBalkong[i-1] + 1):
        print(f"INSERT INTO Stol VALUES ({chairCount},{j},{i},'Balkong',2);")
        chairCount += 1

RadSizeGalleri = [33, 18, 17]
for i in range(1,4):
    for j in range(1, RadSizeGalleri[i-1] + 1):
        print(f"INSERT INTO Stol VALUES ({chairCount},{j},{i},'Galleri',2)")
        chairCount += 1